...
def get_wmt_enfr_train_set(directory):
  ...
  print("Inside get_wmt_enfr_train_set")
  train_path = os.path.join(directory, "giga-fren.release2.fixed")
  if not (gfile.Exists(train_path +".fr") and gfile.Exists(train_path +".en")):
    print("Inside Loop, File not found !")
...
def prepare_squad_data(data_dir, en_vocabulary_size, fr_vocabulary_size, tokenizer=None):
  ...
  create_vocabulary(fr_vocab_path, train_path + ".out", fr_vocabulary_size, tokenizer)
  create_vocabulary(en_vocab_path, train_path + ".in", en_vocabulary_size, tokenizer)
